...
const SeekerFormDetail = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${BASE_URL}/services/seeker/forms/${id}`, { headers })
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      <div className="flex justify-center flex-shrink">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-20 w-full lg:w-3/4">
          ...
          <div className="grid grid-cols-2 gap-11">
  <div className="mb-5">
    <label className="block mb-7 text-xl font-medium">
      Resume Link:
    </label>
    <a
      ...
      className="border text-lg border-gray-300 rounded-md p-2 py-4 w-full bg-gray-200 text-blue-600 underline"
    >
      Click Here
    </a>
  </div>
