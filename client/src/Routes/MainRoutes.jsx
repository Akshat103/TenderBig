    ...
    <>
      ...
      <Suspense fallback={
        ...
        <Routes>
          ...
          <Route path='/auctionmaterial' element={<AuctionMaterialForm/>}/>
          <Route path='/jointventure' element={<JointVenture/>}/>
          <Route path='/tenderfillingonline' element={<TenderFillingOnline/>}/>
          <Route path='/tenderfillingoffline' element={<TenderFillingOffline/>}/>
          <Route path='/tenderfillingoffline' element={<TenderFillingOffline/>}/>
          <Route path="/gemregistration" element={<EarnGems/>}/>
