...
const TenderImg = `${import.meta.env.BASE_URL}images/tender-result.png`;
...
const TenderCard = ({ title,country,Authority,TendorNo,description,userCategory,contractValue, state,BRR, deadline, tenderValue,location, referenceNo, tenderId, summary, }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded p-6 mb-4 border-[2px] border-black/20">
      ...
      <p className="mb-4 absolute right-12 lg:mr-80 text-gray-600"><strong>location:</strong> {location}</p>
      </div>
      <div className="flex">
      <p className="mb-4 relative text-gray-600"><strong>Sector: </strong> {referenceNo}</p>
      <p className="mb-4 absolute right-12 lg:mr-80 text-gray-600"><strong>tenderId:</strong> {summary}</p>
      </div>
      <div className="flex">
      <p className="mb-4 relative text-gray-600"><strong>country:</strong> {country}</p>
      <p className="mb-4 absolute right-12 lg:mr-80 text-gray-600"><strong>state:</strong> {state}</p>
      </div>
      <div className="flex">
      <p className="mb-4 relative text-gray-600"><strong>BRR:</strong> {BRR}</p>
      <p className="mb-4 absolute right-12 lg:mr-80 text-gray-600"><strong>Authority:</strong> {Authority}</p>
      </div>
      <div className="flex">
      <p className="mb-4 relative text-gray-600"><strong>TendorNo:</strong> {TendorNo}</p>
      <p className="mb-4 absolute right-12 lg:mr-80 text-gray-600"><strong>description:</strong> {description}</p>
      </div>
      <div className="flex">
      <p className="mb-4 absolute right-12 lg:mr-80 text-gray-600"><strong>tenderValue:</strong> {tenderValue}</p>
      </div>
...
Welcome to our comprehensive platform for Tender Results and Contract Awards in India. Our mission is to provide you with a wealth of information and insights into the competitive world of tendering and procurement.

On our user-friendly website, you can effortlessly navigate through a vast repository of Tender Results and Bids awarded from various government departments and Public Sector Undertakings (PSUs) across India. Stay updated with the latest developments in the Indian tendering landscape, giving you a clear view of market trends and competitor strategies.

With our advanced search and filtering options, you can tailor your queries to find precisely what you need. Whether you're interested in tenders by location, industry, or project size, our platform has you covered.
</div>
</div>
        <div className="grid mt-24 grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
