...
const Employer = () => {
  ...
  const getAmount = async () => {
    const {
      data: { price },
    } = await axios.get(`${BASE_URL}/formprice/Employer/price`, { headers });
    return price;
  };
  ...
  const StoreAtDB = (requestBody) => {
    const token = localStorage.getItem("token");
    axios
      .post(`${BASE_URL}/services/employer/submit-form`, requestBody, {
        headers: {
          auth: token,
        },
      })
      ...
      <div className="container py-8 mx-auto max-w-[1244px]">
            ...
            <div className="flex">
              ...
              <div className="mx-1 mb-4 basis-1/2">
                ...
                <label htmlFor="company" className="flex items-center">
                  {" "}
                  <RiBuilding2Line className="mr-2" /> Company Name{" "}
                </label>{" "}
                <input
                  required
                  type="text"
            ...
            <div className="flex">
              ...
              <div className="mx-1 mb-4 basis-1/2">
                ...
                <label htmlFor="cwork" className="flex items-center">
                  {" "}
                  <AiOutlineUser className="mr-2" /> Company Work{" "}
                </label>{" "}
                <input
                  required
                  type="text"
        ...
        >
          ...
          >
            ...
            <p className="mt-2">
              {" "}
              S-30, 2nd floor Dwarika towercentral spine, vidhyadhar nagar,
              jaipur, 302039{" "}
            </p>{" "}
          </motion.div>{" "}
          <motion.div
