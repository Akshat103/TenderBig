...
const Seeker = () => {
  ...
  const getAmount = async () => {
    const {
      data: { price },
    } = await axios.get(`${BASE_URL}/formprice/Seeker/price`, { headers });
    return price;
  };
  useEffect(() => {
    const token = localStorage.getItem("token");
    ...
    <div className="container py-8 mx-auto max-w-[1244px]">
      <div className="grid max-w-[1244px] md:grid-cols-12 md:gap-16 mt-5">
        ...
        <div
          className={
            !isSmallScreen
              ? "w-96 px-8 py-8 mx-auto"
              : "col-span-8 px-8 py-8 mx-auto"
          }
        >
          {currentPage === 0 && (
            <form
              ...
              className="col-span-8 p-8 mx-auto border-2 shadow-lg rounded-xl"
            >
              {/* Global Section */}
                  ...
                  <div className="relative">
                    ...
                    <div className="md:flex">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`border ${
                          !isSmallScreen ? "w-36" : "flex-grow"
                        } rounded-sm px-3 py-2 mt-1 flex-grow text-black bg-gray-100 focus:border-red-700 focus:ring-2 focus:ring-red-700 focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`}
                        placeholder={
              ...
              <button
                ...
                disabled={!isFormValid || !isLoggedIn} // Disable the button if the form is not valid or the user is not logged in
              >
                Next
              </button>
              {!isLoggedIn && (
