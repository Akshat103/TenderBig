...
router.post("/all-tenders", isNotUser, verifyToken, tenderController.getAllTender);

//Prograsive search by query in url
router.post("/search",verifyToken, checkSubscription, tenderController.search);

//Search from Form Data filled 
router.post("/advance-search",checkSubscription, verifyToken, tenderController.advanceSearch);
...
//Delete tender
router.delete("/tender/:tenderId", verifyToken, isNotUser, tenderController.deleteTender);
